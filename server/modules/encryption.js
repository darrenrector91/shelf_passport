...
//this handles the actual salting and hashing and then the user is turned around and
//sent back to the controller through the user/route to the server.js and finally
//to the login page to login with the new registration
